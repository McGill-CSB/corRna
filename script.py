...
class filterSeq:
	...
	def result(self,out):
		...
		if(WRITETOFILE):
			...
			f.write('CorRNA results\n')
			f.write('Search method, sequence, correlation, #mutations, MFE, bootstrap\n')
		for s in out:
			ext = ''
			#if(re.search(s[0],'F')):
...
if __name__=='__main__':
	## collect input
	try: 
		optlist, args = getopt.getopt(sys.argv[1:], 'ohbs:m:n:e:d:f:rgvja:u:', ["help"])
